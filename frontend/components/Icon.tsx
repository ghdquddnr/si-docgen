...
const PATHS: Record<IconName | "download" | "back" | "settings", React.ReactNode> = {
  dashboard: (
    <path
      strokeLinecap="round"
...
export function Icon({
  ...
  name: IconName | "download" | "back" | "settings";
  className?: string;
}) {
  return (
    <svg
